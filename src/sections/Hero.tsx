    ...
    <section id="inicio" className="relative min-h-screen overflow-hidden pt-28">
      <div className="container grid min-h-[calc(100vh-7rem)] items-center gap-12 pb-20 lg:grid-cols-[1.08fr_0.92fr]">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <Badge className="mb-6 border-violet-300/20 bg-violet-400/[0.07] text-violet-100">
          ...
          <p className="mt-4 font-display text-xl font-medium text-cyan-100 sm:text-2xl">
            {profile.title}
          </p>
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-lg border border-white/10 bg-slate-950/70 shadow-violet backdrop-blur-xl">
            ...
            <div className="p-6">
              <div className="mb-6 flex items-center gap-4">
                <div className="grid h-16 w-16 place-items-center rounded-lg border border-cyan-300/20 bg-cyan-300/[0.08]">
              ...
              <div className="space-y-3">
                {servicePillars.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className="group flex gap-3 rounded-lg border border-white/10 bg-white/[0.035] p-4 transition duration-300 hover:-translate-y-1 hover:border-cyan-300/30 hover:bg-white/[0.065]"
                    >
                      <Icon className="mt-1 text-cyan-200" size={20} />
                      <div>
